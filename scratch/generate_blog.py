...
<head>
    ...
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Patient Education Blog | Karmanya Ayurveda Pune">
    <meta name="twitter:description" content="Doctor-authored clinical guides on Ayurvedic treatment for knee pain, sciatica, PCOD, Panchakarma, and insomnia.">
    <meta name="twitter:image" content="https://karmanyaayurveda.com/images/doctor-consult.webp">
    <script type="application/ld+json">
    {{
      "@context": "https://schema.org",
      "@type": "Blog",
      "name": "Karmanya Ayurveda Patient Education Blog",
      "url": "https://karmanyaayurveda.com/blog/",
      "description": "Doctor-authored clinical guides on Ayurvedic treatment for knee pain, sciatica, PCOD, Panchakarma, and chronic conditions.",
      "publisher": {{
        "@type": "MedicalClinic",
